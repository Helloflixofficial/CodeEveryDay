    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="absolute inset-0 flex items-center">
                  <div className="p-8 md:p-16 max-w-3xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <Link href={`/anime/${spotlights[0].id}`}>
                        <button className="bg-red-600 hover:bg-red-700 text-white px-10 py-4 rounded-xl font-black text-xl transition-all duration-300 transform hover:scale-105 shadow-2xl border-2 border-red-400 flex items-center justify-center gap-3 w-full sm:w-auto">
                          <span className="text-2xl">▶️</span>
                          WATCH NOW
                        </button>
                      </Link>
                      <Link href={`/anime/${spotlights[0].id}`}>
                        <button className="bg-white/20 backdrop-blur-md border-2 border-white text-white hover:bg-white hover:text-black px-10 py-4 rounded-xl font-black text-xl transition-all duration-300 transform hover:scale-105 shadow-2xl w-full sm:w-auto">
                          ℹ️ MORE INFO
                        </button>
                      </Link>
                    </div>
          ...
          {/* Beautiful Stats Footer */}
          <div className="mt-20 bg-gradient-to-r from-gray-800 to-gray-700 rounded-3xl p-12 text-center shadow-2xl border border-gray-600">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
              ...
              <div className="space-y-2">
                ...
                <div className="text-gray-300 font-medium">Trending</div>
              </div>
              <div className="space-y-2">
                <div className="text-4xl font-black text-orange-500">
                  {topAiring.length}
                </div>
                <div className="text-gray-300 font-medium">Airing</div>
              </div>
              <div className="space-y-2">
                <div className="text-4xl font-black text-purple-500">
                  {mostPopular.length}
                </div>
                <div className="text-gray-300 font-medium">Popular</div>
              </div>
              <div className="space-y-2">
                <div className="text-4xl font-black text-green-500">
                  {latestEpisodes.length}
                </div>
                <div className="text-gray-300 font-medium">Latest</div>
              </div>
            </div>
          </div>
        </div>
...
// Server-side props - Make sure this is properly exported
